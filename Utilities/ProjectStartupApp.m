classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Machine-Learning-Methods-Clustering";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Position = [2 242 274 177];
            app.WelcomeTitle.Text = 'Welcome to Machine Learning Methods: Clustering';
            ...
            app.Image.Position = [16 130 245 209];
            app.Image.ImageSource = 'MLMethodsClustering.png';
            ...
            app.ReviewTitle.Position = [2 242 274 177];
            app.ReviewTitle.Text = 'Welcome to Machine Learning Methods: Clustering';
