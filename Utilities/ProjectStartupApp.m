classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        ImagePath {mustBeFile} = fullfile("Images","MLMethodsClustering.png"); 
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.StartUpAppUIFigure.Position = [100 100 279 491];
            ...
            app.WelcomePanel.Position = [-551 94 244 410];
            ...
            app.CoverImage.ImageSource = 'MLMethodsClustering.png';
            ...
            app.FeedBackPanel.Position = [-291 94 236 409];
