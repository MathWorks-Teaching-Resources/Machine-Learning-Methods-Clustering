...
Download or clone this repository. Open MATLAB, navigate to the folder containing these scripts and double\-click on [MLMethodsClustering.prj](https://github.com/MathWorks-Teaching-Resources/Machine-Learning-Methods-Clustering/blob/release/MLMethodsClustering.prj). It will add the appropriate files to your MATLAB path and open an app that asks you where you would like to start. 
